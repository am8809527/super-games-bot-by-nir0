...
module.exports = {
  ...
  */
  run: async (client, message, args) => {
    ...
    else return message.channel.send(build.emojis.err + "** | The game already started..**");
          ...
          .then(async (collected) => {
            ...
            if (content == "y")
              return message.channel.send(new MessageEmbed()
                ...
                .setTitle(build.emojis.done + " Finali Iam The Winner!!"));
            else {
              message.channel.send(new MessageEmbed()
                .setColor(build.colors.err)
                .setTitle(build.emojis.err + "Okay, You won this time!")
              );
